...
document.getElementById('add-btn').addEventListener('click', async () => {
  ...
  // Optionally validate link format here if needed
...
// Render table with editable status, notes, follow-up date only and link button
function renderApplications(applications) {
  ...
  applications.forEach(app => {
    ...
    // Make sure to safely handle missing or empty links
