...
async function onLogin() {
  // Fetch full user data to ensure we have the ID
...
function renderApplications(applications) {
  ...
  applications.forEach(app => {
    ...
    row.innerHTML = `
      ...
      <td><input type="date" value="${app.deadline || ''}" onchange="editField('${app.id}', 'deadline', this.value)"></td>
      <td>
      ...
      <td><input type="date" value="${app.date_applied || ''}" onchange="editField('${app.id}', 'date_applied', this.value)"></td>
      <td><input type="date" value="${app.follow_up_date || ''}" onchange="editField('${app.id}', 'follow_up_date', this.value)"></td>
      <td><input value="${app.notes || ''}" onchange="editField('${app.id}', 'notes', this.value)"></td>
